        ...
        <div class="card-content">
          ...
          >
            <a
              class="link"
              target="_blank"
              href="https://github.com/xyzroe/filebrowser/blob/master/docs/customization.md#custom-branding"
        ...
        <div class="card-content">
          ...
          >
            ...
            <a
              class="link"
              target="_blank"
              href="https://github.com/xyzroe/filebrowser/blob/master/docs/command-execution.md#hook-runner"
              >{{ t("settings.documentation") }}</a
            >
          </i18n-t>
